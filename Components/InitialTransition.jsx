...
const InitialTransition = ({ onLoadingComplete }) => {
  ...
  return (
    ...
    >
      {loading && (
        <h2 className="relative text-2xl font-extrabold text-white after:content-[''] after:absolute after:bottom-[2px] after:right-[-17px] after:w-[10px] after:h-[10px] after:bg-[#0bfa9d] after:rounded-full">Ahmad</h2>
      )}
    </motion.div>
  );
};
